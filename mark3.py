...
logging.basicConfig(filename='mark3.log', level=logging.INFO, format='%(asctime)s:%(message)s')
...
nine = datetime.datetime(now.year, now.month, now.day) + datetime.timedelta(hours=8, minutes=59)
if now > nine:
